...
data_dir='/media/np451/Seagate Backup Plus Drive/DATA/Cyto-D/Cyto_D.23.10.18/P3_24h'
 ...
 for jj=1:(numel(Rc)-1)
     ...
     %%%%% here I changed Period to 23.
      if Rc{jj}.Period==0; 
          ...
          cc=cc+1; f_rest(cc)=Rc{jj}.fp1;f_peak(cc)= Rc{jj}.pks(end); volt_exp(cc)= Rc{jj}.Volt;
      end
 end
