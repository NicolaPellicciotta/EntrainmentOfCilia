function [] = movie2avi_nicola_timestamp_line(minFrame,maxFrame,times_slower,skip_frames,flag_crop,x,y)
...
index_line = sub2ind(size(fs(:,:,1)), rIndex, cIndex);     % Linear indices
