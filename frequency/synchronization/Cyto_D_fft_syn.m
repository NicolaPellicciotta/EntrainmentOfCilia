close all;
clear all
data_dir='/media/np451/Seagate Backup Plus Drive/DATA/Cyto-D/Cyto_D.23.10.18/'; %%% experiment in DMEM P/S

directories={'P2','P2_3h','P2_7h','P2_24h','P3','P3_3h','P3_7h','P3_24h'};
cd(data_dir);

for dd=8:numel(directories)
...
%%%%% load data and the roi
    ...
    Endind=strfind(R{nc,jj}.filename,'.23Oct');
